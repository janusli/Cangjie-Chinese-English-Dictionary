...
%%%邊線等紙張佈局
%\usepackage[centering,top=2.7cm,bottom=2.7cm,headsep=0.5cm,footskip=0.8cm,left=2.7cm,right=2.7cm,columnsep=2.5em]{geometry} 
...
\newcommand{\mitem}[1]{\item \HGB #1} %mainitem
...
\newenvironment{mainenum}[1]{\begin{enumerate}[label=\protect\fontsizec{0.42cm}\color{black}\ncircbrs{\arabic*},ref=\arabic*,itemindent=1.1em,noitemsep,labelsep=0.1em,leftmargin=0em,topsep=0pt,partopsep=0pt] %此enum與原\Deff命令中enum一致item序列黑方形
		  #1}
