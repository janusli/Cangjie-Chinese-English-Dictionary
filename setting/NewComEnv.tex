...
\thelemmasign{\hypertarget{#3}{\lettrine[lines=3,lhang=0.39,loversize=-0.2]{\hspace{0.15cm}\SPSB{\buttonleftsupera{#1}}{\buttonleftsuba{#2}}\hspace{-0.33cm}\color{myred}\IBMP #3}{} }} {{\color{myred}{\ubufont #4}，{\ubufont #5}，{\ubufont #6}，{\ubufont #7}。}}}
...
\index[CJ]{{\ubufontc #4}{\PFTL #3}} %倉頡索引
\index[BH]{{\color{red}\fontsizec{0.7cm}\ncircds{#1}}![{\ubufontc#4}]{\PFTL#3}} %總筆畫數索引
	\thelemmasign{\hypertarget{#3}{\lettrine[lines=2,lhang=0.43,loversize=-0.2]{\hspace{0.15cm}\SPSB{\buttonleftsuperc{#1}}{\buttonleftsubc{#2}}\hspace{-0.87cm}\color{GeRed}\IBMP #3}{} }} {{\color{GeRed}{\ubufont #4}，{\ubufont #5}，{\ubufont #6}，{\ubufont #7}。}}}
