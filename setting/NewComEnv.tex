...
\newcommand\buttonleftsupera[1]{  %漢字左上角部首外筆畫數目標示
	...
	(0,0) -- (0,0);  
	\pgftext[base,x=.7cm,y=.5cm]{\fontsizec{.5cm}\color{myred}\ncircds{#1}}  
	\end{tikzpicture}
}
...
\newcommand\buttonleftsuperb[1]{  %漢字左上角部首外筆畫數目標示
	...
	-{Fast Triangle[length=0mm,inset=0mm]}] %fill=white,
	(0,0) -- (0,0);  
	\pgftext[base,x=.7cm,y=.5cm]{\fontsizec{.5cm}\color{GeRed}\ncircds{#1}}  
	\end{tikzpicture}
}
...
\newcommand\buttonleftsuperc[1]{  %漢字左上角部首外筆畫數目標示
	...
	-{Fast Triangle[length=0mm,inset=0mm]}] %fill=white,
	(0,0) -- (0,0);  
	\pgftext[base,x=.37cm,y=.2cm]{\fontsizec{.43cm}\color{GeRed}\ncircds{#1}}  
	\end{tikzpicture}
}
...
\newcommand\buttonleftsubc[1]{
	...
	-{Fast Triangle[length=0mm,inset=0mm]}] %fill=white,
	(0,0) -- (0,0);  %
	\draw [draw=GeRed] (-1,-0.2) circle (.19cm); 
	\pgftext[base,x=-1cm,y=-0.3cm]{\ZSKS\fontsizec{.33cm}\color{GeRed} #1} 
	\end{tikzpicture}
}
...
\thelemmasign{\hypertarget{#3}{\lettrine[lines=3,lhang=0.377,loversize=-0.22]{\hspace{0.15cm}\SPSB{\buttonleftsupera{#1}}{\buttonleftsuba{#2}}\hspace{-0.33cm}\color{myred}\IBMP #3}{} }} {{\color{myred}{\ubufont #4}，{\ubufont #5}，{\ubufont #6}，{\ubufont #7}。}}}


%次常用字
\NewDocumentCommand \centryb {o o m o o m m} %詞條主樣式
{\subsectionmark{[{\ubufontc#4}]{\PFTL#3}} \phantomsection\addcontentsline{toc}{subsection}{#4\textbf{#3}}%   
\index[SJM]{{\ubufont\color{red}\Large#5}![{\ubufontc#4}]{\PFTL#3}} %漢字四角碼索引 
\index[GY]{{\ubufont\color{red}\Large #6}!{\ubufontc#4}{\PFTL#3}[{\ubufontc#7}]} %國音索引
\index[YY]{{\ubufont\color{red}\Large#7}!{\ubufontc#4}{\PFTL#3}[{\ubufontc#6}]} %粵音索引
\index[CJ]{{\ubufontc #4}{\PFTL #3}} %倉頡索引
\index[BH]{{\color{red}\fontsizec{0.7cm}\ncircds{#1}}![{\ubufontc#4}]{\PFTL#3}} %總筆畫數索引
	\thelemmasign{\hypertarget{#3}{\lettrine[lines=3,lhang=0.377,loversize=-0.22]{\hspace{0.15cm}\SPSB{\buttonleftsuperb{#1}}{\buttonleftsubb{#2}}\hspace{-0.33cm}\color{GeRed}\IBMP #3}{} }} {{\color{GeRed}{\ubufont #4}，{\ubufont #5}，{\ubufont #6}，{\ubufont #7}。}}}
...
\index[CJ]{{\ubufontc #4}{\PFTL #3}} %倉頡索引
\index[BH]{{\color{red}\fontsizec{0.7cm}\ncircds{#1}}![{\ubufontc#4}]{\PFTL#3}} %總筆畫數索引
	\thelemmasign{\hypertarget{#3}{\lettrine[lines=2,lhang=0.377,loversize=-0.22]{\hspace{0.15cm}\SPSB{\buttonleftsuperc{#1}}{\buttonleftsubc{#2}}\hspace{-0.87cm}\color{GeRed}\HNMA #3}{} }} {{\color{GeRed}{\ubufont #4}，{\ubufont #5}，{\ubufont #6}，{\ubufont #7}。}}}
...
\NewDocumentCommand \Etymology {m} {{\PFTL #1}}
